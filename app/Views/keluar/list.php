...
<div class="wrapper">
  ...
  <section class="content">
   <div class="container">
        ...
        <div class='pd-2'>
        <a class=" btn btn-primary mb-3" href="/keluar/create" role="button"><i class="fa fa-plus"></i> Tambah</a>
        ...
        <tbody>
            <?php $no = 1; 
            foreach($keluar as $srm) : ?>
            <tr>
            <th scope="row"><?= $no ?></th>
            <td><?= $srm['tanggal_surat'] ?></td>
            <td><?= $srm['perihal'] ?></td>
            <td><?= $srm['file'] ?></td>
            <td><?= $srm['kode_instansi'] ?></td>
            <td><?= $srm['id_admin'] ?></td>
            <td>
                <div class="container-fluid" style="display: flex;">
                <a class="btn btn-warning mr-3" href="/keluar/edit/<?= $srm['id'] ?>"><i class="fa fa-edit"></i></a>
                <form action="/keluar/delete/<?= $srm['id'] ?>" method="post">
