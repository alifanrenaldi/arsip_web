...
<div class="wrapper">
  ...
  <section class="content">
   <div class="container">
        ...
        <div class='pd-2'>
        <a class=" btn btn-primary mb-3" href="surat_masuk/create" role="button"><i class="fa fa-plus"></i> Tambah</a>
        ...
        <tbody>
            ...
            <tr>
            <th scope="row"><?= $no ?></th>
            <td><?= $mhs['nomor_surat'] ?></td>
            <td><?= $mhs['tanggal_surat'] ?></td>
            <td><?= $mhs['tanggal_diterima'] ?></td>
            <td><?= $mhs['asal_surat'] ?></td>
            <td><?= $mhs['perihal'] ?></td>
            <td><?= $mhs['file'] ?></td>
            <td><?= $mhs['kode_instansi'] ?></td>
            <td><?= $mhs['id_pengguna'] ?></td>
            <td>
